      ...
      <div className={css.container}>
        ...
        <div>
          ...
          <div>
            ...
            {size && size.map((curr,index)=>{
             return <div className={`${css.mbtns}`} key={index}>{curr}</div>
            })}
            
              {inF ? (
                <button onClick={()=>setInF(false)}>Add Size </button>
              ) : (<>
                <input type="text" onChange={(e)=>setGetSize(e.target.value)}  />   <button onClick={handleSizeInput}> Enter </button></>
              )}
            ...
            {color && color.map((curr,index)=>{
             return <div className={`${css.mbtns}`} key={index}>{curr}</div>
              ...
              {colorF ? (
                ...
                <input type="text" onChange={(e)=>setGetSize(e.target.value)}  />   <button onClick={handleColorInput}> Enter </button></>
              )}
